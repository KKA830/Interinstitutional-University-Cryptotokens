...
const SplitSecondaryTextInput = ({ titleLeft, titleRight, placeholderLeft, placeholderRight, isErrorLeft, isErrorRight, onChangeLeft, onChangeRight, valueLeft, valueRight }) => {
  return (
